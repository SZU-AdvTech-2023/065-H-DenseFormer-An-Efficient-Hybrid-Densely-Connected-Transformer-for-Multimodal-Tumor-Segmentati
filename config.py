...
data_path = {
    # competition
    'Hecktor21':r'E:\Hecktor21\train_3d_seg',
    'PI-CAI22':r'E:\PI-CAI22\train_2d_seg',
...
BATCH_SIZE = 2 if '3d' in MODE else 8   #48 for resunet else 24(A100) 12(V100) 18(A100 old)


CKPT_PATH = './ckpt/{}/fold{}'.format(MODE,str(CURRENT_FOLD))
...
SETUP_TRAINER = {
  'output_dir':'./ckpt/{}/{}'.format(DATASET,MODE),
  'optimizer':'Adam',
  'loss_fun':LOSS_FUN,
  'class_weight':None,
